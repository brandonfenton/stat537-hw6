...
The reduced PC4 uses only the snowpack levels for June through September. Most observations fall along a line in the plots, although there is some vertical scatter where observations had little snowpack in those months but large enough values of other variables to
